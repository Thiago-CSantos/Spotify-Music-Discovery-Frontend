      ...
      return (
            <>
                  <div className='xl:px-56 tallM:px-2 px-2 grid sm:grid-cols-3 gap-4 justify-center'>
                        <Card to='testando' imgSrc={myGif} h1='Musica que está tocando' paragrafo='Buscar a música que está tocando.' />
                        <Card to='' imgSrc={myGif} h1='fd' paragrafo='lorem akmdnkalsjdjsahd jksad sa dlkhasdkjl asd sad asdasdasdasdasd asdas d' />
